(() => {
  ...
  window.loadGrowthPanel = async () => {
    ...
    try {
      ...
      el('growthSchedule').textContent = `Agenda atual: ${appState.scheduleBrt?.length || 0} horários. O plano não modifica os disparos automáticos.`;
