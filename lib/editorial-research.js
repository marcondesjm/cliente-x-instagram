  ...
  if (customRadar) {
    ...
    return {
      ...
      slides: [
        ...
        { eyebrow: 'O SINAL DO MERCADO', title: business.impact, body: `${item.source} publicou ${headline} em ${dateLabel}.` },
