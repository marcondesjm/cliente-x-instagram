...
function businessNarrative(theme = {}, options = {}) {
  ...
  return {
    ...
    offer,
    audience,
    cta: `Se sua equipe corre o dia inteiro e ainda sente que algo importante fica para trás, podemos conversar. Eu ajudo empresas com ${humanOffer}. Me chame no Direct.`
  };
}
  ...
  if (customRadar) {
    ...
    return {
      ...
      slides: [
        ...
        { eyebrow: 'O QUE MUDA NA ROTINA', title: business.solution, body: `${business.solutionDetail} Comece por uma rotina real, combine o resultado esperado e mantenha a conferência necessária.` },
