...
function localizedNews(item = {}, theme = {}) {
  ...
  return match || {
    title: sourceTitle,
    fact: sourceTitle ? `A matéria informa: ${sourceTitle}.` : `A fonte publicou uma atualização sobre ${theme.label}.`
  };
}
  ...
  if (customRadar) {
    ...
    return {
      ...
      slides: [
        ...
        { eyebrow: 'O QUE A MATÉRIA DIZ', title: news.fact, body: `Título original: ${item.title}` },
