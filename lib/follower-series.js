...
// Episodes 1-4 retain their historical cover. Upcoming episodes use dedicated
// illustrative assets, shared only between the cover and its companion Story.
const episodePhotos = {
  5: 'weekly-report', 6: 'knowledge-base', 7: 'proposal-followup',
  8: 'order-check', 9: 'client-onboarding', 10: 'email-triage',
  11: 'file-organization', 12: 'after-sales', 13: 'procedure-update',
  14: 'automation-review'
};
export function seriesPack(episode) {
  ...
  return {
    ...
    slides: [
      { ...slide(`AUTOMAÇÃO PRÁTICA · ${episode}/14`, title, task), imagePath: episodePhotos[episode]
        ? `docs/uploads/follower-series/episode-${episode}-${episodePhotos[episode]}.png`
