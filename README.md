...
6. O workflow `.github/workflows/instagram-feed-cliente-x.yml` fica agendado para publicar às 6:30, 8:10, 9:00, 12:30, 13:30, 15:10 e 17:30 no horário de Brasília. Esse agendamento roda no GitHub Actions e não depende do PC ligado.
